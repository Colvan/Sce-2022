...
const XmixDrix: FC = () => {
  ...
  const handleClick = (index: number) => {
    ...
    if (win == 0) {
      ...
      if (turn.player == 3) {
        ...
        setBannerDisplay(BannerDisplay.oplay)
      }
    }
  }
  ...
  const checkWin = () => {
    let winner = 0
    if (bricks[0].state != 0 && bricks[0].state == bricks[1].state && bricks[1].state == bricks[2].state) {
      winner = bricks[0].state
    } else if (bricks[3].state != 0 && bricks[3].state == bricks[4].state && bricks[4].state == bricks[5].state) {
      winner = bricks[3].state
    } else if (bricks[6].state != 0 && bricks[6].state == bricks[7].state && bricks[7].state == bricks[8].state ) {
      winner = bricks[6].state
    } else if (bricks[0].state != 0 && bricks[0].state == bricks[3].state && bricks[3].state == bricks[6].state) {
      winner = bricks[0].state
    ...
    if (winner > 0) {
      ...
      if (winner == 1) {
        setBannerDisplay(BannerDisplay.xwin)
      } else {
